...
var setToLoggedIn = function setToLoggedIn() {
  loggedIn = true;
};

var setToLoggedOut = function setToLoggedOut() {
  loggedIn = false;
};

var onCreateCustomer = function onCreateCustomer() {
  if (loggedIn === true && customerName.value !== '') {
    $('input[name="customer[user_id]"]').attr('value', store.user.id);
    var data = getFormFields(this);
    api.createCustomer(data).then(ui.onCreateCustomerSuccess).then(onGetCustomer).catch(ui.onError);
  }
};

var onGetCustomer = function onGetCustomer() {
  api.getCustomer().then(ui.onGetCustomerSuccess).catch(ui.onError);
};
...
var barberId = document.getElementById('appointment-barber-id');
var appointmentDate = document.getElementById('appointment-date');
var appointmentUpdateDate = document.getElementById('appointment-update-date');
var apptIdUpdate = document.getElementById('appointment-update-id');
var apptIdDelete = document.getElementById('appointment-cancel-id');

var onGetIds = function onGetIds() {
  var findElement = document.querySelectorAll('.unique');
  var latestResult = findElement.length - 1;
  var selectLatest = findElement[latestResult];
  var id = selectLatest.getAttribute('data-id');
  barberId.value = id;
};
...
var onCreateAppointment = function onCreateAppointment(event) {
  ...
  if (appointmentDate.value !== '') {
    api.createAppointment(data).then(ui.onCreateAppointmentSuccess).then(onGetAppointments).catch(ui.onCreateAppointmentFailure);
  } else {
    ui.onCreateAppointmentFailure();
  }
};

var onGetAppointments = function onGetAppointments() {
  api.getAppointments().then(ui.onGetAppointmentsSuccess).catch(ui.onError);
};

var onUpdateAppointment = function onUpdateAppointment(event) {
  event.preventDefault();
  var data = getFormFields(this);
  var id = apptIdUpdate.value;
  if (appointmentUpdateDate.value !== '') {
    api.updateAppointment(data, id).then(ui.onUpdateAppointmentSuccess).then(onGetAppointments).catch(ui.onUpdateAppointmentFailure);
  } else {
...
var onDeleteAppointment = function onDeleteAppointment(event) {
  event.preventDefault();
  var id = apptIdDelete.value;
  api.deleteAppointment(id).then(ui.onDeleteAppointmentSuccess).then(onGetAppointments).catch(ui.onDeleteAppointmentFailure);
};
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <ul id=\"barbs-id\" data-id=\""
    ...
    + "</li>\n    <li>Services: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.services : stack1), depth0))
    + "</li>\n    <li>Max Price: $"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.max_price : stack1), depth0))
    + "</li>\n    <li>Busiest Day: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.busiest_day : stack1), depth0))
    + "</li>\n    <li>Busiest Time: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.busiest_time : stack1), depth0))
    + "</li>\n    <li>Rating: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.average_rating : stack1), depth0))
    + "</li>\n  </ul>\n  <br>\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "<div class=\"barbers-result\">\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.barbers : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
...
var barberEvents = __webpack_require__(43);
var customerEvents = __webpack_require__(8);
var appointmentEvents = __webpack_require__(10);
var passwordChangeOld = document.getElementById('old');
var passwordChangeNew = document.getElementById('new');
var createDate = document.getElementById('appointment-date');
var updateId = document.getElementById('appointment-update-id');
var updateDate = document.getElementById('appointment-update-date');
var cancelId = document.getElementById('appointment-cancel-id');
...
var closeAppointmentModal = function closeAppointmentModal() {
...
var appointmentUpdateModal = document.getElementById('appointment-update-modal');
var closeAppointmentUpdateModal = function closeAppointmentUpdateModal() {
...
var appointmentCancelModal = document.getElementById('appointment-cancel-modal');
var closeAppointmentCancelModal = function closeAppointmentCancelModal() {
...
var hideQuickSearch = function hideQuickSearch() {
...
var passwordChangeOld = document.getElementById('old');
var passwordChangeNew = document.getElementById('new');
var searchSubmit = document.getElementById('find-submit');
...
var store = __webpack_require__(1);
var showCustomerTemplate = __webpack_require__(23);
var searchSubmit = document.getElementById('find-submit');

var onCreateCustomerSuccess = function onCreateCustomerSuccess(data) {
  store.customer = data.customer;
  $('.success').append(' Your settings have also been saved.');
};

var onGetCustomerSuccess = function onGetCustomerSuccess(data) {
  if (data !== null) {
    store.customer = data.customer;
    var showCustomerHtml = showCustomerTemplate({ customer: data.customer });
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "\n  <ul data-id=\""
    ...
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.customer : depth0)) != null ? stack1.zip : stack1), depth0))
    + "</li>\n    <li>Your Hairstyle: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.customer : depth0)) != null ? stack1.services : stack1), depth0))
    + "</li>\n    <li>Your Max Price: $"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.customer : depth0)) != null ? stack1.max_price : stack1), depth0))
    + "</li>\n    <li>Most Convienent Day: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.customer : depth0)) != null ? stack1.best_day : stack1), depth0))
    + "</li>\n    <li>Most Convienent Time: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.customer : depth0)) != null ? stack1.best_time : stack1), depth0))
    + "</li>\n  </ul>\n";
},"useData":true});
...
var updateAppointment = function updateAppointment(data, id) {
  return $.ajax({
...
var store = __webpack_require__(1);
var showAppointmentsTemplate = __webpack_require__(42);
var appointmentModal = document.getElementById('appointment-modal');
var appointmentUpdateModal = document.getElementById('appointment-update-modal');
var appointmentCancelModal = document.getElementById('appointment-cancel-modal');
var createDate = document.getElementById('appointment-date');
...
var onCreateAppointmentSuccess = function onCreateAppointmentSuccess(data) {
...
var onCreateAppointmentFailure = function onCreateAppointmentFailure() {
  $('#create-appointment-modal-failure').text('Could not schedule appointment. Please ensure your date and time are accurate.');
};

var onGetAppointmentsSuccess = function onGetAppointmentsSuccess(data) {
  if (data !== null) {
...
var onUpdateAppointmentSuccess = function onUpdateAppointmentSuccess() {
  $('.failure').text('');
...
var onUpdateAppointmentFailure = function onUpdateAppointmentFailure() {
  $('#update-appointment-modal-failure').text('Sorry, please try again.');
};

var onDeleteAppointmentSuccess = function onDeleteAppointmentSuccess() {
  $('.failure').text('');
...
var onDeleteAppointmentFailure = function onDeleteAppointmentFailure() {
...
module.exports = {
  ...
  onCreateAppointmentFailure: onCreateAppointmentFailure,
  onGetAppointmentsSuccess: onGetAppointmentsSuccess,
  onUpdateAppointmentSuccess: onUpdateAppointmentSuccess,
  onUpdateAppointmentFailure: onUpdateAppointmentFailure,
  onDeleteAppointmentSuccess: onDeleteAppointmentSuccess,
  onDeleteAppointmentFailure: onDeleteAppointmentFailure,
  onError: onError
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <ul id=\"appt-id\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n    <h5 class=\"name-result\">Appt # "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + ":</h6>\n    <li>"
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.barber : stack1)) != null ? stack1.services : stack1), depth0))
    + " with "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.barber : stack1)) != null ? stack1.name : stack1), depth0))
    + " at "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.barber : stack1)) != null ? stack1.shop_name : stack1), depth0))
    + "</li>\n    <li>Date & Time: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.date : stack1), depth0))
    + "</li>\n    <li>Phone #: "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.barber : stack1)) != null ? stack1.phone : stack1), depth0))
    + "</li>\n  </ul>\n  <br>\n\n";
},"3":function(container,depth0,helpers,partials,data) {
    return "<button class=\"update\">Update Times</button>\n<button class=\"cancel\">Make Cancellation</button>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=depth0 != null ? depth0 : (container.nullContext || {});

  return "\n"
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.appointments : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\n"
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.appointments : depth0),{"name":"if","hash":{},"fn":container.program(3, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
...
var showBarbersTemplate = __webpack_require__(11);
var barberName = document.getElementById('barber-name');
var barberShop = document.getElementById('barber-shop');
var barberPhone = document.getElementById('phone');
var barberPrice = document.getElementById('barber-price');
var barberZip = document.getElementById('barber-zip');
var barberRate = document.getElementById('barber-rating');
var appointmentModal = document.getElementById('appointment-modal');

var onGetBarberId = function onGetBarberId(event) {
  event.preventDefault();
  if (userZip.value !== '' && userPrice.value !== '') {
    api.getBarbers().then(ui.onGetBarberIdSuccess).then(onGetBarber).catch(ui.onError);
  } else {
    $('.success').text('');
...
var onGetBarberIdQuick = function onGetBarberIdQuick(event) {
  event.preventDefault();
  api.getBarbers().then(ui.onGetBarberIdQuickSuccess).then(onGetBarber).catch(ui.onError);
};

var onGetBarber = function onGetBarber() {
  var showBarbersHtml = showBarbersTemplate({ barbers: store.barbers });
  if (barberId.value !== '') {
    api.getBarber(barberId.value).then(ui.onGetBarberSuccess).catch(ui.onError);
  } else {
    $('.failure').text('');
...
var onCreateBarber = function onCreateBarber(event) {
  event.preventDefault();
  var data = getFormFields(this);
  if (barberName.value !== '' && barberShop.value !== '' && barberShop.value !== '' && barberPhone.value !== '' && barberPrice.value !== '' && barberZip.value !== '' && barberRate.value !== '') {
    api.createBarber(data).then(ui.onCreateBarberSuccess).catch(ui.onError);
  } else {
    $('.success').text('');
    $('.failure').text('Please provide a value for all fields.');
  }
...
var getBarber = function getBarber(id) {
  return $.ajax({
...
var store = __webpack_require__(1);
var showBarbersTemplate = __webpack_require__(11);
var showBarberTemplate = __webpack_require__(46);
var showBarberTemplateLoggedOut = __webpack_require__(47);
var barberId = document.getElementById('barber-id');
var appointmentModal = document.getElementById('appointment-modal');
...
var userStyle = document.getElementById('style');

var onGetBarberIdSuccess = function onGetBarberIdSuccess(data) {
...
var onGetBarberIdQuickSuccess = function onGetBarberIdQuickSuccess(data) {
  var savedZip = store.customer.zip;
  var savedPrice = store.customer.max_price;
  var savedDay = store.customer.best_day;
  var savedTime = store.customer.best_time;
  var savedStyle = store.customer.services;
  store.barbers = data.barbers;
  barberId.value = '';
  var i = 0;
  while (i < store.barbers.length && barberId.value !== store.barbers[i].id + '') {
...
var onGetBarberSuccess = function onGetBarberSuccess(data) {
  var showBarberHtmlLoggedOut = showBarberTemplateLoggedOut({ barber: data.barber });
  var showBarberHtml = showBarberTemplate({ barber: data.barber });
  var showBarbersHtml = showBarbersTemplate({ barbers: store.barbers });
  $('.failure').text('');
...
var onCreateBarberSuccess = function onCreateBarberSuccess(data) {
...
module.exports = {
  onGetBarberIdSuccess: onGetBarberIdSuccess,
  onGetBarberIdQuickSuccess: onGetBarberIdQuickSuccess,
  onGetBarberSuccess: onGetBarberSuccess,
  onCreateBarberSuccess: onCreateBarberSuccess,
  onError: onError
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"barber-result\">\n  <ul class=\"unique\" id=\"barb-id\" data-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.barber : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">\n    <h5 class=\"name-result\">"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.barber : depth0)) != null ? stack1.name : stack1), depth0))
    + ":</h5>\n    <li>Shop: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.barber : depth0)) != null ? stack1.shop_name : stack1), depth0))
    + "</li>\n    <li>Phone: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.barber : depth0)) != null ? stack1.phone : stack1), depth0))
    + "</li>\n    <li>Zip: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.barber : depth0)) != null ? stack1.zip : stack1), depth0))
    + "</li>\n    <li>Services: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.barber : depth0)) != null ? stack1.services : stack1), depth0))
    + "</li>\n    <li>Max Price: $"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.barber : depth0)) != null ? stack1.max_price : stack1), depth0))
    + "</li>\n    <li>Busiest Day: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.barber : depth0)) != null ? stack1.busiest_day : stack1), depth0))
    + "</li>\n    <li>Busiest Time: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.barber : depth0)) != null ? stack1.busiest_time : stack1), depth0))
    + "</li>\n    <li>Rating: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.barber : depth0)) != null ? stack1.average_rating : stack1), depth0))
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"barber-result\">\n  <ul id=\"barb-id-signed-out\" data-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.barber : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">\n    <h5 class=\"name-result\">"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.barber : depth0)) != null ? stack1.name : stack1), depth0))
    + ":</h5>\n    <li>Shop: "
...
// module
exports.push([module.i, ".logo {\n  text-align: center;\n}\n\n/* Hide additional content for logged out users, etc.*/\n.hide-content {\n  display: none;\n}\n\n.selections {\n  clear: both;\n}\n\n.log-in-forms {\n  text-align: center;\n}\n\n.success {\n  color: darkgreen;\n  text-align: center;\n}\n\n.failure {\n  color: red;\n  text-align: center;\n}\n\n.panel {\n  background-color: #fff;\n  border: 0 solid;\n  margin-bottom: 20px;\n}\n\n.panel-default {\n  border-color: #ddd;\n}\n\n.panel-heading {\n  border-bottom: 2px solid;\n  font-size: 1.8em;\n  letter-spacing: -1px;\n  padding: 10px 20px;\n  text-align: center;\n  text-transform: uppercase;\n}\n\n.panel-body {\n  padding: 20px;\n  text-align: center;\n}\n\nul {\n  display: inline-block;\n  text-align:left;\n}\n\n.modal {\n    display: none;\n    height: 100%;\n    left: 0;\n    overflow: auto;\n    position: fixed;\n    top: 0;\n    vertical-align: middle;\n    width: 100%;\n    z-index: 1;\n}\n\n.modal-content {\n    background-color: blue;\n    border: 1px solid #888;\n    margin: 15% auto;\n    padding: 20px;\n    width: 45%;\n}\n\n.modal-failure {\n  color: red;\n  text-align: center;\n}\n\n.appointment-modal-failure{\n  color: red;\n  text-align: center;\n}\n\n.close {\n    color: #aaa;\n    float: right;\n    font-size: 28px;\n    font-weight: bold;\n}\n\n.close:hover,\n.close:focus {\n    color: black;\n    cursor: pointer;\n    text-decoration: none;\n\n}\n\n.name-result {\n  font-weight: bold;\n  text-transform: uppercase;\n}\n", ""]);
